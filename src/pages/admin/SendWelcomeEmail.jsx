...
function SendWelcomeEmail() {
  ...
  // Si no es admin, no renderizar (ya redirigió)
  if (!isAdmin) {
    return null;
  }
    ...
    <Layout>
      <div className="py-10 px-4 max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          >
            Envía un email de bienvenida a los usuarios que hayas creado en Firebase
          </p>
        </div>
        ...
        >
          ...
          >
            {loading ? 'Enviando...' : '✉️ Enviar Email de Bienvenida'}
          </button>
        </form>
        ...
        >
          ...
          >
            ...
            <br />
            2. Guarda sus datos en Firestore (colección "users")
            <br />
            3. Ingresa aquí el nombre y email del usuario
            <br />
            4. El usuario recibirá un email de bienvenida a Escritores Tucumanos
          </p>
        </div>
